...
function setItem(jsdata){
    ...
    if(localStorage.getItem('womenproduct')==null){
        localStorage.setItem('womenproduct','[]');
    }
  
    var old_data=JSON.parse(localStorage.getItem('womenproduct'));
    old_data.push(cartItems);
  
    localStorage.setItem("womenproduct",JSON.stringify(old_data));
...
function DisplayItems(){
    let displayitem=localStorage.getItem("womenproduct");
